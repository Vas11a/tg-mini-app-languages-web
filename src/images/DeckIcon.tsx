...
export const DeckIcon: React.FC<DeckIconProps> = ({
  color = "currentColor",
  background,
  size,
  className,
  ...
  return (
    ...
    >
      {background && (
        <rect x="0" y="0" width="16" height="16" rx="4" fill={background} />
      )}

      <path
        d="M3.05 4.75a.7.7 0 01.7-.7h3.5a.7.7 0 110 1.4h-3.5a.7.7 0 01-.7-.7zM3.75 7.05a.7.7 0 100 1.4h2.5a.7.7 0 100-1.4h-2.5z"
        fill={color}
      />

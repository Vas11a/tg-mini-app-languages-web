    ...
    <div className="p-2 flex flex-col gap-2 rounded-2xl bg-primary/15">
      <div className="relative flex justify-between ">
        <input
          type="text"
          placeholder="Search"
          className="w-full pr-7 text-dark bg-white focus:outline-1 focus:outline-primary  placeholder:text-gray-300 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_4px_10px_rgba(0,0,0,0.04)] rounded-lg text-[16px]  p-2.5 py-2"
        />
        <SearchIcon

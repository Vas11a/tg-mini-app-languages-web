...
const DeckListModule = ({}: Props) => {
  return (
    <div className="flex-1 overflow-y-auto min-h-0 flex flex-col gap-6 pb-6 mt-6">
      {/* <EmptyDeck /> */}
      <div className="flex flex-col gap-2 p-4 rounded-2xl drop-shadow mx-1 bg-white">
        ...
        <div className="flex justify-between items-center  ">
          ...
          <div className="py-1 px-3 rounded-xl bg-primary/70 text-[14px] text-white font-medium">
            B2
          </div>
        </div>
        <div className="border-t border-primary/30 pt-2 flex items-center gap-4">
      ...
      <div className="flex flex-col gap-2 p-4 rounded-2xl drop-shadow mx-1 bg-white">
        ...
        <div className="flex justify-between items-center  ">
          <div className="flex flex-col">
            <div className=" text-gray-300 text-[14px]">12 words</div>
            <div className=" text-primary/50 text-[14px]">ru-en</div>
          </div>
          <div className="py-1 px-3 rounded-xl bg-primary/70 text-[14px] text-white font-medium">
            A0
        ...
        <div className="border-t border-primary/30 pt-2 flex items-center gap-4">
          <div className="flex-1 relative">
            <div className="w-full h-1.5 rounded-2xl bg-primary/15"></div>
            <div className=" absolute bg-primary/80 z-20 h-1.5 rounded-2xl top-0 w-[80%]"></div>
          </div>
          <div className="text-dark text-[14px]"> 80%</div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2 p-4 rounded-2xl drop-shadow mx-1 bg-white">
        ...
        <div className="border-t border-primary/30 pt-2 flex items-center gap-4">
          <div className="flex-1 relative">
            <div className="w-full h-1.5 rounded-2xl bg-primary/15"></div>
            <div className=" absolute bg-primary/80 z-20 h-1.5 rounded-2xl top-0 w-[12%]"></div>
          </div>
          <div className="text-dark text-[14px]"> 12%</div>
        </div>
      </div>
